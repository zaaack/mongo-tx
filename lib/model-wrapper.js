...
var ModelWrapper = function () {
  function ModelWrapper(model, options) {
    ...
    this.createLock = function (id) {
      return createLock('document:' + model.name() + '__' + id, txTimeout);
    };
    this.locks = {};
  }
  ...
  (0, _createClass3.default)(ModelWrapper, [{
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 2:
                ...
                (0, _utils.debug)('remove snap', doc._id);
                _context10.next = 8;
                return this.removeSnap(doc._id);

              case 8:
                (0, _utils.debug)('release', doc._id);
                _context10.next = 11;
    ...
    value: function () {
      var _ref11 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11() {
        var snaps, snapId, _snaps$snapId, action, doc, ret;
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 2:
                ...
                _context11.next = _context11.t2 === 'create' ? 9 : _context11.t2 === 'update' ? 14 : _context11.t2 === 'remove' ? 17 : 20;
                break;

              case 9:
                _context11.next = 11;
                return this.model.findOneAndRemove({ _id: doc._id }, doc);

              case 11:
                ret = _context11.sent;

                (0, _utils.debug)('findOneAndRemove ret', ret);
