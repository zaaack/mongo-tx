  ...
  (0, _createClass3.default)(Lock, [{
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2() {
        ...
        var _options, collectionName, writeConcern, db, notDelete, wait, queue, maxWaitTime, maxLockTime, now;

        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _options = this.options, collectionName = _options.collectionName, writeConcern = _options.writeConcern, db = _options.db, notDelete = _options.notDelete, wait = _options.wait, queue = _options.queue, maxWaitTime = _options.maxWaitTime, maxLockTime = _options.maxLockTime;
