 ...
 * @return
 */
var fixCrash = function () {
  var _ref10 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee10() {
    var _options5, createModel, createLock, txColName, txModel, txLock, txDocs, txDoc, txManager;

    return _regenerator2.default.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _options5 = this.options, createModel = _options5.createModel, createLock = _options5.createLock, txColName = _options5.txColName;
...
var TxManager = function () {
  function TxManager(nameOrTx, options) {
    ...
    this.options = options = (0, _assign2.default)({}, defaults, options);
    var _options2 = this.options,
        txTimeout = _options2.txTimeout,
        createModel = _options2.createModel,
        createLock = _options2.createLock,
        txColName = _options2.txColName,
        lockTxName = _options2.lockTxName;
    ...
    this.txLocks = [];
    if (lockTxName) {
      this.txLocks = lockNames.map(function (lockName) {
        return createLock('transaction:' + lockName);
      });
    }
    this.models = [];
  ...
  (0, _createClass3.default)(TxManager, [{
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _promise2.default.all(this.txLocks.map(function (tl) {
                  return tl.lock();
                }));
    ...
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6() {
        ...
        var _options3, commitRetry, commitRetryInterval;
        ...
        return _regenerator2.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 3:
                _options3 = this.options, commitRetry = _options3.commitRetry, commitRetryInterval = _options3.commitRetryInterval;
                _context6.next = 6;
    ...
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee8() {
        ...
        var _options4, rollbackRetry, rollbackRetryInterval;
        ...
        return _regenerator2.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 3:
                _options4 = this.options, rollbackRetry = _options4.rollbackRetry, rollbackRetryInterval = _options4.rollbackRetryInterval;
                _context8.next = 6;
        ...
        return _regenerator2.default.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _context9.next = 2;
                return this.txModel.findOneAndRemove({ _id: this.tx._id });
...
function MongoTx(options) {
  var runTx = function () {
    var _ref11 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(name, fn, _options) {
      var tmp, txMgr;
      return _regenerator2.default.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 4:
              options.createModel = _context11.sent;
              _context11.next = 7;
              return options.createLock;

            case 7:
              options.createLock = _context11.sent;
              txMgr = new TxManager(name, options);
              ...
              return _context11.abrupt('return', txMgr.run(fn));

            case 11:
              return _context11.abrupt('return', txMgr);
    ...
    return function runTx(_x6, _x7, _x8) {
      return _ref11.apply(this, arguments);
    };
  }();

  (0, _assign2.default)(runTx, {
    options: options,
    fixCrash: fixCrash,
    createDocLock: function createDocLock() {
      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return _modelWrapper2.default.createDocLock.apply(_modelWrapper2.default, args.concat([options]));
    }
  });
  return runTx;
}